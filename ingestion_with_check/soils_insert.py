...
command1 = "/s/parsons/b/others/sustain/db-tools/mongodb-database-tools-rhel80-x86_64-100.3.0/bin/mongoimport --port 27018 --db sustaindb --collection soils_statsgo --file "+ jq_op_path +" --jsonArray > "+ log_file_path+" 2>&1"
command2 = "/s/parsons/b/others/sustain/db-tools/mongodb-database-tools-rhel80-x86_64-100.3.0/bin/mongoimport --port 27018 --db sustaindb --collection soils_statsgo --mode upsert --upsertFields=MUID --file "+ jq_op_path +" --jsonArray > "+ log_file_path+" 2>&1"
