...
combined_x1_path = "C:\\Users\\sapmitra\\Documents\\PostFireDebris\\data\\X3_Zonal_resampled"
...
csv_file = os.path.join(combined_x1_path, "combined_x3.csv")
try:
    with open(csv_file, 'wb') as csvfile:
        ...
        for key in x1_dict:
            d = x1_dict[key]
            data = {"GridCode": key, "X3_soil": d["x1"], "Count": d["count"]}
